        ...
        <div className="container-xs flex flex-col items-start gap-[1.13rem] md:px-[1.25rem]">
          ...
          <div className="flex flex-col gap-[0.75rem] self-stretch">
            <div className="flex justify-center gap-[1.25rem] md:flex-col">
              <Input
                ...
                suffix={
                  searchBarValue17?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue17("")} height={24} width={24} fillColor="#626262ff" />
                  ) : (
                    <Img
                ...
                className="flex-grow gap-[2.13rem] rounded-[10px] border border-solid border-blue_gray-100_01 pl-[1.00rem] pr-[1.63rem] !text-gray-700 sm:pr-[1.25rem]"
              />
              <SelectBox
                shape="round"
                indicator={
              ...
              />
              <div className="flex w-[22%] justify-center gap-[1.25rem] md:w-full">
                <SelectBox
                  shape="round"
                  indicator={
                    <Img src="images/img_arrowdown_gray_700.svg" alt="Arrow Down" className="h-[1.50rem] w-[1.50rem]" />
                  }
                  name="Bedroom Dropdown"
                  placeholder={`Bed - 3`}
                  options={dropDownOptions}
                  className="w-full rounded-[10px] border border-solid border-blue_gray-100_01 font-bold"
                />
                <Button
                  color="white_A700"
                  size="3xl"
                  ...
                  className="min-w-[7.50rem] gap-[0.75rem] rounded-[10px] border border-solid border-blue_gray-100_01 pl-[0.94rem] pr-[1.31rem] font-bold text-gray-700 sm:pr-[1.25rem]"
                >
                  More
                </Button>
              </div>
              <Button
                ...
                className="min-w-[7.75rem] gap-[0.63rem] rounded-[10px] px-[1.00rem] font-bold"
              >
                Search
              </Button>
            </div>
