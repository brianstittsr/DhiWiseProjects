...
export default function ListingCard({ ...props }: Props) {
  return (
    <div {...props} className={`${props.className} flex flex-col items-center`}>
      ...
      />
      <div className="flex flex-col gap-[1.50rem] self-stretch rounded-bl-[10px] rounded-br-[10px] border border-solid border-red-100_01 bg-white-a700 px-[1.25rem] py-[1.88rem] sm:py-[1.25rem]">
