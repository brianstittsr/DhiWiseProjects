...
export default function AgentProfileCard({ ...props }: Props) {
  return (
      ...
      <div className="flex flex-col gap-[1.50rem] self-stretch rounded-bl-[10px] rounded-br-[10px] border border-solid border-red-100_01 bg-gray-50_01 px-[1.25rem] py-[1.88rem] sm:py-[1.25rem]">
        ...
        <div className="flex flex-col gap-[1.13rem]">
          <div className="flex justify-center gap-[1.25rem]">
            <div className="flex items-center gap-[0.75rem]">
              <Img src="images/img_bookmark.svg" alt="Bedrooms Icon" className="h-[1.25rem] w-[1.25rem]" />
              <Heading as="h6" className="text-[1.00rem] font-semibold text-gray-700">
                3 Bed Room
              </Heading>
            </div>
            <div className="flex flex-1 items-center gap-[0.75rem] px-[1.25rem]">
              <Img src="images/img_user.svg" alt="Bathrooms Icon" className="h-[1.25rem] w-[1.25rem]" />
              <Heading as="h6" className="text-[1.00rem] font-semibold text-gray-700">
                1 Bath
              </Heading>
            </div>
